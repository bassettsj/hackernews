  ...
  actions: {
    FETCH_FEED({ commit, state }, { feed, page, prefetch }) {
      ...
      return lazy(
        ...
        () =>
          this.$axios.$get(`https://hn.nuxtjs.org/api/${feed}/${page}.json`, {
    ...
    FETCH_ITEM({ commit, state }, { id }) {
      return lazy(
        ...
        () => this.$axios.$get(`https://hn.nuxtjs.org/api/item/${id}.json`),
    ...
    FETCH_USER({ state, commit }, { id }) {
      return lazy(
        ...
        () => this.$axios.$get(`https://hn.nuxtjs.org/api/user/${id}.json`),
